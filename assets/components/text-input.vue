<template>
    <input ref="input" :name="nameAttr" type="text" :maxlength="maxlength" :class="{'lcf-input-has-error': hasError}" :value="value" :placeholder="placeholder" @change="change" @keydown.enter.prevent="change" />
</template>
